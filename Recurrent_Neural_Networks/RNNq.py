...
training_set = train_dataset.iloc[:,1:2] # selecting the open stock prices part

#Feature Scaling
from sklearn.preprocessing import MinMaxScaler
sc = MinMaxScaler(feature_range = (0,1)) # as we want to scale the
training_set_scaled = sc.fit_transform(training_set)

#creating the data structure with 60 timesteps & 1 o/p
x_train = []
y_train = []
...
#getting predicted stock prices of 2017
...
plt.plot(predicted_stock_prices, color = 'yellow', label = "predicted_stock_price")
